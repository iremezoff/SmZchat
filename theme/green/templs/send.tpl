...
<tr valign="bottom"><td style="width: 270;" nowrap><input name="to" style="width:130px; cursor:hand;" title="<?echo$lang['clear'];?>" value="" onclick="JavaScript: document.send_form.to.value='';" readonly>
